...
function FAQItem({ q, a, icon: Icon, defaultOpen = false }) {
  return (
    <details
          ...
          <aside className="lg:col-span-4">
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <div className="mt-5 space-y-3">
                ...
                <a
                  href="#contacto"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/10 bg-white/10 px-5 py-3 text-sm font-semibold text-white hover:bg-white/15"
                >
