          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-300">
                Profesionales certificados que trabajan en conjunto. La agenda se maneja por tipo de servicio (no por fisioterapeuta).
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-400">
                  Puedes consultar el CV en PDF de cada integrante del equipo.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col gap-2 sm:flex-row">
                  ...
                  <a
                    ...
                    title={p.cvUrl ? "Abrir CV en PDF" : "Aún no hay CV cargado"}
                  >
