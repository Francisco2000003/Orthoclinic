...
export const STAFF = [
  {
    ...
    years: 19,
    rating: 4.9,
    badges: ["UNAM", "Cirugía de mano", "Alta especialidad", "Cedula Profesional: 06062334"],
...

  {
    ...
    years: 16,
    rating: 5.0,
    badges: ["UNAM", "Cirugía de mano", "Alta especialidad", "Cedula Profesional: 09941258"],
  ...
  years: 5,
  rating: 4.8,
  badges: ["Cédula 13622910", "Geriatría", "Activación adulto mayor", "RCP/DEA"],
  bio:
    "Lic. en Terapia Física con experiencia en rehabilitación clínica y activación física para adultos mayores. Actualmente en formación de maestría en fisioterapia geriátrica.",
  cvUrl: cvAkbitt,
  profile: {
    bio:
      "Egresado de fisioterapia (IPETH), con experiencia en clínica de rehabilitación, campo deportivo y atención a pacientes de diferentes diagnósticos. Enfoque en organización, planeación y trabajo interdisciplinario.",
    education:
...

{
  ...
  bio:
    "Lic. en Terapia Física con experiencia hospitalaria y clínica. Manejo de pacientes pre/post quirúrgicos y enfoque en rehabilitación deportiva.",
  cvUrl: cvAreli,
  profile: {
    bio:
      "Egresada de la Universidad Politécnica de Huatusco (2020–2024). Experiencia en entorno hospitalario (Covadonga) y atención de múltiples perfiles clínicos: postquirúrgicos, alteraciones posturales, dolor agudo/crónico y geriatría.",
    education: "Licenciatura en Terapia Física — Universidad Politécnica de Huatusco (2020–2024).",
    specialties: [
...

{
  ...
  years: 2,
  rating: 4.7,
  badges: ["Ejercicio terapéutico", "Agentes físicos", "Razonamiento clínico"],
  bio:
    "Lic. en Terapia Física con enfoque en rehabilitación deportiva y ejercicio terapéutico progresivo basado en evidencia (isométrico, concéntrico, excéntrico y pliométrico).",
  cvUrl: cvClaudio,
  profile: {
    bio:
      "Egresado de la Universidad Politécnica de Huatusco (2020–2024). Experiencia en rehabilitación deportiva y clínica hospitalaria, con énfasis en movilidad precoz y prevención de desacondicionamiento físico en pacientes encamados.",
    education: "Licenciatura en Terapia Física — Universidad Politécnica de Huatusco (2020–2024).",
    specialties: [
...

{
  ...
  years: 2,
  rating: 4.7,
  badges: ["Anatomía palpatoria", "Lesiones músculo-esqueléticas", "Fisioterapia invasiva"],
  bio:
    "Lic. en Terapia Física con experiencia clínica en pacientes post-operatorios, geriátricos y deportivos. Manejo de agentes físicos y enfoque en tratamiento individualizado.",
  cvUrl: cvDavid,
  profile: {
    bio:
      "Egresado de la Universidad Politécnica de Huatusco (2020–2024). Experiencia hospitalaria en Covadonga y práctica clínica con abordaje a lesiones agudas/crónicas, postquirúrgicos y pacientes con amputación (pre y post protésico).",
    education: "Licenciatura en Terapia Física — Universidad Politécnica de Huatusco (2020–2024).",
    specialties: [
...

{
  ...
  bio:
    "Lic. en Terapia Física con experiencia en unidad básica de rehabilitación y entorno hospitalario. Atención a pacientes pediátricos y geriátricos con patologías traumáticas y neurológicas.",
  cvUrl: cvJose,
  profile: {
    bio:
      "Egresado de la Universidad Politécnica de Huatusco (2020–2024). Experiencia en rehabilitación en Nogales y servicio social en Covadonga con manejo de pacientes preoperatorios, postquirúrgicos, neurológicos, respiratorios, traumatológicos y deportivos.",
    education: "Licenciatura en Terapia Física — Universidad Politécnica de Huatusco (2020–2024).",
    specialties: [
